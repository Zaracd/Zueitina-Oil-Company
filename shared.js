...
const NEWS_DATA = [
  ...
  },
  {
    ...
    summaryAr:'إعلان ضمن الأخبار الحديثة بالموقع الرسمي للشركة يخص تأهيل شركات متخصصة في مجال النظافة العامة.',
    summaryEn:'An official recent-news item for preliminary qualification of companies specialized in public cleaning.',
